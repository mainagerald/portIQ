...
const LoginPage: React.FC = () => {
  ...
  // Effect to handle Google OAuth callback parameters
  useEffect(() => {
    ...
    // If we have OAuth callback parameters, process the login
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Toast and redirect handled by useEffect
    } catch (err: any) {
  ...
  return (
    <div className="max-w-md mx-auto mt-16 p-8 bg-white rounded-lg shadow-lg dark:bg-gray-800 dark:text-white transition-all duration-300">
      ...
      <div className="mt-6 text-center">
        <a href="/register" className="text-blue-600 hover:underline dark:text-blue-400">Don't have an account? Register</a>
      </div>
      <div className="text-center mt-3">
        <a href="/reset-password" className="text-blue-600 hover:underline dark:text-blue-400">Forgot password?</a>
      </div>
    </div>
  );
};
