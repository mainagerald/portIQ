...
const Footer: React.FC = () => (
  <footer className="w-full bg-black text-gray-400 py-10 mt-auto border-t border-gray-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        <div>
          <div className="flex items-center mb-4">
            ...
            <div className="font-bold text-xl text-white">Tradez</div>
          </div>
          <p className="text-gray-400 mb-4">
            The next generation trading platform for digital assets.
          </p>
        ...
        <div>
          ...
          <div className="flex">
            <input 
              ...
              className="bg-gray-900 text-white px-4 py-2 rounded-l-md focus:outline-none focus:ring-1 focus:ring-indigo-500 w-full" 
            />
