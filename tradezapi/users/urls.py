...
from .views import RegisterAPIView, CustomTokenObtainPairView, VerifyEmailAPIView, GoogleLoginAPIView, PasswordResetRequestAPIView, PasswordResetConfirmAPIView
